...
volatile uint16_t cycle_stage  = 0; //keeps track of current postion in the 20ms cycle
volatile uint16_t servo_value3 = 31; //1.5ms 1500/64us (1/16MHz/1024)

ISR(TIMER2_COMPA_vect) {
	//on the first interrupt this code will run
if (cycle_stage == 0) {
	//start of pulse
	PORTB |= (1 << PORTB3); // Pin HIGH
